  ...
  <div class="footer-wrapper">
    <footer ref="footerSectionEl" class="footer-section">
      ...
      <div class="footer-socials">
        <a
          href="https://github.com/mohamedasan07"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/in/mohamed-asan07/"
          target="_blank"
          rel="noopener noreferrer"
          class="footer-social-link footer-social-link--roll"
        >
        ...
        <a
          href="mailto:mohamedasan357@gmail.com"
          class="footer-social-link footer-social-link--roll"
        >
          <span class="oh oh--social">
            <span>
      ...
      <div class="footer-bottom">
        ...
        <div class="footer-bottom-right">
          ...
          <span class="oh"><span>{{ currentYear }} Asan</span></span>
        </div>
      </div>
    </footer>
  </div>
