<template>
  <div v-if="isVisible" class="intro-loader" aria-hidden="true">
    ...
    <div class="intro-title" :class="{ 'is-ready': isTitleReady }" ref="titleEl">
      <div class="title-row">
        <div class="title-charts-cont"><span ref="seg1">MO</span></div>
<div class="title-charts-cont"><span ref="seg2">HAMED</span></div>

<div class="title-space">&nbsp;</div>

<div class="title-charts-cont"><span ref="seg3">A</span></div>
<div class="title-charts-cont"><span ref="seg4">SAN</span></div>
      </div>
    </div>
  </div>
</template>
